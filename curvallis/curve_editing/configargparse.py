...
class ArgumentParser(argparse.ArgumentParser):
    ...
    def parse_known_args(self, args = None, namespace = None,
        ...
        for stream in config_streams[::-1]:
            ...
            # Parse command line arguments to check for different inputs later
            # Need this to fill out argument names (Ex. inp becomes input_file)
            args_com = argparse.ArgumentParser.parse_known_args(
    ...
    def _open_config_files(self, command_line_args):
        ...
        # check if able to open config files
        no_config = False
